...
def autodetect_ray_address_or_die():
    """Returns an appropriate Ray address to connect to on this node."""

    if "RAY_ADDRESS" in os.environ:
        redis_addresses = [os.environ["RAY_ADDRESS"]]
    else:
...
def validate_redis_address(address):
    ...
    if address == "auto":
        address = autodetect_ray_address_or_die()
