...
def train(config, reporter):
    ...
    summed_loss = autoencoder_loss + il_loss
    ...
    for i in range(1000):
        ...
        for _ in range(len(data) // BATCH_SIZE):
            ...
            x, cur_il_loss, cur_auto_loss, _ = sess.run(
                [recons_obs, il_loss, autoencoder_loss, train_op], feed_dict={
...
#            print(x[0], batch[0]["obs"])
        ...
        reporter(timesteps_total=i, mean_accuracy=acc, mean_loss=auto_loss)
        if i % 1 == 0:
